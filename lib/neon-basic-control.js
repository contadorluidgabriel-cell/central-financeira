...
import { initialEntryModePatch, scheduledEntryModePatch } from './entry-mode-policy.mjs';
...
export async function scheduleUnifiedEntryMode(organizationId, mode, effectiveMonth) {
  ...
  return updateBasicSettingsLegacy(organizationId, scheduledEntryModePatch(mode, effectiveMonth, monthKey()));
}
